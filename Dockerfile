...
ENV PATH $HADOOP_HOME/bin:$JAVA_HOME/bin:$NGINX_HOME/sbin:$PATH
...
COPY ./configs/nginx.conf $NGINX_HOME/conf/nginx.conf

#nginx
ADD ./tools/nginx-1.16.1.tar.gz /usr/local/src
